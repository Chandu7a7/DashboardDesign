import { Sidebar, SingleStats, TotalSavings } from "../components";
import {
  HiArrowSmallDown,
  HiCurrencyDollar,
  HiUserGroup,
    ...
    <div className="h-auto border-t dark:border-blackSecondary border-blackSecondary border-1 flex dark:bg-blackPrimary bg-whiteSecondary">
      ...
      <div className="dark:bg-blackPrimary bg-whiteSecondary w-full pt-6 pl-9 max-sm:pt-6 max-sm:pl-1">
        ...
        <div className="flex flex-wrap justify-between gap-5 px-5 w-[95%]">
          <SingleStats>
            <SingleStats.StatsCategory statsCategory="Profit">
              <HiCurrencyDollar className="text-2xl" />
            </SingleStats.StatsCategory>
            <SingleStats.MoneyStats moneyAmount="$8650.50">
            ...
            </SingleStats.MoneyStats>
            <SingleStats.PercentageStats isPositive={true} percentage="25%" />
          </SingleStats>

          <SingleStats>
            <SingleStats.StatsCategory statsCategory="Spendings">
              <HiShoppingCart className="text-2xl" />
            </SingleStats.StatsCategory>
            <SingleStats.MoneyStats moneyAmount="$1590">
            ...
            <SingleStats.PercentageStats isPositive={false} percentage="5%" />
          </SingleStats>

          <SingleStats>
            <SingleStats.StatsCategory statsCategory="Revenue">
              <HiCurrencyDollar className="text-2xl" />
            </SingleStats.StatsCategory>
            <SingleStats.MoneyStats moneyAmount="12400.75">
              <p className="text-white dark:bg-green-700 bg-green-500 w-20 h-10 flex gap-1 items-center justify-center font-semibold">
                <HiArrowSmallUp className="text-blackPrimary text-xl" />{" "}
                <span>15.1%</span>
              </p>
            </SingleStats.MoneyStats>
            <SingleStats.PercentageStats
              isPositive={true}
              percentage="15.2%"
            />
          </SingleStats>
          ...
          <SingleStats>
            <SingleStats.StatsCategory statsCategory="New Users">
              <HiUserGroup className="text-2xl" />
            </SingleStats.StatsCategory>
            <SingleStats.MoneyStats moneyAmount="450">
              <p className="text-white dark:bg-green-700 bg-green-500 w-20 h-10 flex gap-1 items-center justify-center font-semibold">
                <HiArrowSmallUp className="text-blackPrimary text-xl" />{" "}
                <span>3.8%</span>
              </p>
